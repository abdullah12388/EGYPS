"""
Django settings for egypes project.
...
SECRET_KEY = 'django-insecure-c&s7zv4s4l6t5x)whbbw_j97aphrw$maq$330b=!5kdllq-2xi'
...
WSGI_APPLICATION = 'egypes.wsgi.application'
ASGI_APPLICATION = 'egypes.asgi.application'
